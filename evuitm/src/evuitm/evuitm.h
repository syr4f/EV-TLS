...
#define EVUITM_VERSION_MAJOR 0
#define EVUITM_VERSION_MINOR 1
#define EVUITM_VERSION_PATCH 0
...
#define EVUITM_API OPP_DLLEXPORT
#elif defined(EVUITM_IMPORT)
#define EVUITM_API OPP_DLLIMPORT
#else
#define EVUITM_API
#endif
